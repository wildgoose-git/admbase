...
Функция СформироватьИсходныеДанныеПроходыPERCo(МассивЗагрузки,МассивОшибок) Экспорт

	//++инициализация, заполнение таблиц
	ИсходнаяТаблица = КонсолидацияТаблицыЗначений.ИнициализироватьТаблицуЗначенийПроходыPERCo();
...
Процедура ЗагрузкаСправочникаСотрудникиСОбработкойОшибок(ИсходнаяТаблица,МассивОшибок)
	...
	ТаблицаОшибок = КонсолидацияТаблицыЗначений.ИнициализироватьТаблицуОшибок();
