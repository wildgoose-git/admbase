...
&НаКлиенте
Процедура ЗагрузитьЗаявкиЗавершение(МассивОшибок = Неопределено,МассивСтруктур=Неопределено)
...
Процедура ПослеЗакрытияФормыКорректировкаЗагружаемыхДанных(Результат, ДополнительныеПараметры) Экспорт
	...
	ЗагрузитьЗаявкиЗавершение(Результат, ДополнительныеПараметры.МассивСтруктур);
