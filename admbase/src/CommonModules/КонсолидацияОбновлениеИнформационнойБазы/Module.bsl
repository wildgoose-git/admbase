...
Процедура ПриДобавленииПодсистемы(Описание) Экспорт
	...
	Описание.Имя    = "КонсолидацияАдминистративныхЗадач";
	Описание.Версия = "2.0.0.2";
	Описание.ИдентификаторИнтернетПоддержки = "КонсолидацияАдминистративныхЗадач";
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик = Обработчики.Добавить();
  	...
  	Обработчик.Процедура           = "КонсолидацияОбновлениеИнформационнойБазы.ПерейтиНаВерсию_2_0_0_2";
  	Обработчик.РежимВыполнения     = "Оперативно";
...
Процедура ПерейтиНаВерсию_2_0_0_2() Экспорт
	
	Запрос = Новый Запрос; 
	
#Область ТекстЗапроса
	Запрос.Текст = "ВЫБРАТЬ
	|	СотрудникиУдалитьНаименованияЗагрузок.НомерСтроки КАК НомерСтроки,
	|	СотрудникиУдалитьНаименованияЗагрузок.Ссылка КАК Ссылка,
	|	СотрудникиУдалитьНаименованияЗагрузок.Наименование
	|ИЗ
	|	Справочник.Сотрудники.УдалитьНаименованияЗагрузок КАК СотрудникиУдалитьНаименованияЗагрузок
	|
	|УПОРЯДОЧИТЬ ПО
	|	НомерСтроки
	|ИТОГИ
...
#КонецОбласти	
	...
	Пока ВыборкаСсылка.Следующий() Цикл
		...
		Пока Выборка.Следующий() Цикл
			СправочникОбъект = Справочники.ЗагружаемыеФИОСотрудников.СоздатьЭлемент();
			СправочникОбъект.Наименование 	= Выборка.Наименование;
			СправочникОбъект.Владелец 		= Выборка.Ссылка;
