...
|ГДЕ
|	ПеремещениеСотрудниковДетальныеЗаписи.Ссылка = Выразить(&Ссылка КАК Документ.ПеремещениеСотрудников)
|
|ОБЪЕДИНИТЬ ВСЕ
|
|ВЫБРАТЬ
...
|ГДЕ
|	ВыселениеСотрудниковДетальныеЗаписи.Ссылка = Выразить(&Ссылка КАК Документ.ВыселениеСотрудников)
|
|ИНДЕКСИРОВАТЬ ПО
|	Сотрудник,
|	ДатаЗаселения
