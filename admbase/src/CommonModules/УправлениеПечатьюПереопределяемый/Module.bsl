...
Процедура ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов) Экспорт
	...
	//d.b.(
	//СписокОбъектов.Добавить(Документы.ЗаявкиDMC);
	//Общежитие
	СписокОбъектов.Добавить(Документы.ЗаселениеСотрудников);
	СписокОбъектов.Добавить(Документы.ПеремещениеСотрудников);
	СписокОбъектов.Добавить(Документы.ВыселениеСотрудников);
	СписокОбъектов.Добавить(Документы.ПриказОбУстанволенииСтоимостиПроживания);
	СписокОбъектов.Добавить(Документы.РасчетСтоимостиПроживания);
	//d.b.)
