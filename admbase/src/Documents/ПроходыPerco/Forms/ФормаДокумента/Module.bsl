...
Процедура ПослеНачалаЧтенияФайлаCSV(ДополнительныеПараметры) Экспорт 
	...
	Для Каждого СтрокаТаблицы Из ТаблицаЗагрузки Цикл
		Структура = КонсолидацияКлиентСервер.ИнициализироватьСтруктуруТаблицыЗагзурок();
...
&НаКлиенте
Процедура ПослеНачалаЧтенияФайлаCSVЗавершение(МассивЗагрузки)
	...
	Иначе
		...
		//АдресВХранилище = ПоместитьВоВременноеХранилище(МассивОшибок,УникальныйИдентификатор);
...
Функция ПолучитьИсходныеДанные(МассивЗагрузки,МассивОшибок)
	Возврат КонсолидацияОбщегоНазначения.СформироватьИсходныеДанныеPERCoСМассивомОшибок(МассивЗагрузки,МассивОшибок);
...
Процедура ПослеЗакрытияФормыКорректировкаЗагружаемыхДанных(Результат, ДополнительныеПараметры) Экспорт
	...
	ПослеНачалаЧтенияФайлаCSVЗавершение(ДополнительныеПараметры.МассивЗагрузки);
